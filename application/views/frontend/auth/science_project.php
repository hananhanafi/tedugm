    ...
    <div class="thumbnail__content text-center">
		<h1 class="heading--primary" id="tipe">Science and Technology Project Competition</h1>
		<h2 class="heading--secondary" style="font-size: 1em;">Science and Technology Project Competition adalah kompetisi penciptaan karya inovatif berupa teknologi dalam bentuk hardware dan atau software yang mana karya tersebut diharapkan dapat menjadi solusi terhadap permasalahan yang ada di Indonesia</h2>
    </div>
  ...
  <div class="container__child signup__form">
    ...
    <form id="formRegister" action="<?php echo site_url('auth/sp_register') ?>" method="POST">
      <div class="form-group">
	    <h4 class= "h12" id="kettipe3">Science Project Competition</h4>
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="instansi" id="Instansi" placeholder="Nama Universitas (kosongkan untuk umum)" value="<?php echo set_value('instansi') ?>" />
