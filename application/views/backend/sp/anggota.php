            ...
            <div class="card-header">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <!-- Supervisor info  -->
                  <?php if (!empty($user['instance_name'])): ?>
                    <div class="col-md-3">  
                      <div class="card" style="width: 15rem;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?= site_url('sp/lock_member') ?>"><button type="button" class="btn btn-primary">Setuju</button></a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="editKetua" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="col-md-12" action="<?=site_url('sp/update_member/ketua')?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editMember1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="col-md-12" action="<?=site_url('sp/update_member/member1')?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editPendamping" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="col-md-12" action="<?=site_url('sp/update_member/pendamping')?>" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editMember2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="col-md-12" action="<?=site_url('sp/update_member/member2')?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?=site_url('sp/delete_member/member1')?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="deleteMember2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <a href="<?=site_url('sp/delete_member/member2')?>" class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>