       ...
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           ...
           <div class="modal-footer">
             ...
             <a href="<?=site_url('admin/cp_payment_confirmation/').$team->user_id.'/'.$team->team_name?>" class="btn btn-primary">Ya</a>
           </div>
         </div>
       </div>
     </div>
     ...
     <div class="modal fade" id="delete<?=$team->user_id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       <div class="modal-dialog" role="document">
         <div class="modal-content">
           ...
           <div class="modal-footer">
             <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
             <a href="<?=site_url('admin/cp_payment_refuse/').$team->user_id.'/'.$team->team_name?>" class="btn btn-danger">Ya</a>
           </div>
         </div>
       </div>
     </div>
