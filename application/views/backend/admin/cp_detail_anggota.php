                ...
                <div class="row">
                  <div class="col-md-3">
                    <div class="card" style="width: 18rem;">
                      <img class="card-img-top" src="<?= base_url('uploads/users/photos/').$team['leader_photo'] ?>" alt="Card image cap">
                      <div class="card-body">
                  ...
                  <?php if (!empty($team['member1_name'])): ?>
                    <div class="col-md-3">
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?= base_url('uploads/users/photos/').$team['member1_photo'] ?>" alt="Card image cap">
                        <div class="card-body">
                  ...
                  <?php if (!empty($team['member2_name'])): ?>
                    <div class="col-md-3">
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?= base_url('uploads/users/photos/').$team['member2_photo'] ?>" alt="Card image cap">
                        <div class="card-body">
